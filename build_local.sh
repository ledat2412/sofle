...
if [ ! -L "vial-qmk/keyboards/sofle/sofle_choc/keymaps/vial" ]; then
    echo "Symlink keymaps in VIAL QMK repository"
    ln --symbolic --force --no-dereference $(pwd)/sofle/sofle_choc/keymaps/vial vial-qmk/keyboards/sofle/sofle_choc/keymaps/
fi

# Build firmware
echo "Building firmware..."
cd vial-qmk
qmk compile -kb sofle/sofle_choc -km notatutorial
qmk compile -kb sofle/sofle_choc -km notatutorial -e CONVERT_TO=kb2040
cd ..
